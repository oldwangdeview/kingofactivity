...
//		saveCrashInfo2File(ex);
	...
	public void collectDeviceInfo(Context ctx) {
		...
		infos.put("deviceMode", MobileName);
...
//		String timeShow = DateTools.getMixedDate();
//		StringBuffer sb = new StringBuffer();
//		sb.append("createTime :" + timeShow + "\r\n");
...
//		sb.append(result);
//		try {
//			String time = DateTools.getCrashDay();
//			String fileName = "log"+ ".txt";
//			String path = FileUtils.APP_CRASH + "/";
