...
import com.scmsw.kingofactivity.interfice.TouchLister;
...
public class YRecycleview extends RecyclerView {
    ...
    private String TAG="YRecycleview";
    /**
     * 是否可以刷新的常量
     */
    ...
    private TouchLister eventliset;
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        switch (action){
            ...
            case MotionEvent.ACTION_MOVE:
                final float deltaY = rawY - lastRawY2;
                final float deltaX = rawX - lastRawX;
...
*/
    ...
    public void seteventlister(TouchLister lister){
        this.eventliset = lister;
    }
    /**
     * 这是一个数据观察者
     */
    ...
    public void onRefreshGone(){
        mHeaderViews.get(0).setVisibility(View.GONE);
        invalidate();
    }
    ...
    public void setbackgournd(){
        ...
        mHeadView.setBackgroundColor(Color.rgb(41,206,126));
        mHeadView.settextcolorforwilte();
        invalidate();
    }
