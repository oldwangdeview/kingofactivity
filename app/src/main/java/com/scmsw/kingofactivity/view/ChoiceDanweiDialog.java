...
public class ChoiceDanweiDialog extends Dialog {

    public ChoiceDanweiDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    public static class Params {
        private final List<ChoiceDanweiDialog.BottomMenu> menuList = new ArrayList<>();
    ...
    public static class Builder {
        ...
        private final ChoiceDanweiDialog.Params p;

        public Builder(Context context) {
            p = new ChoiceDanweiDialog.Params();
            p.context = context;
        }

        public ChoiceDanweiDialog.Builder setCanCancel(boolean canCancel) {
            this.canCancel = canCancel;
            return this;
        }

        public ChoiceDanweiDialog.Builder setShadow(boolean shadow) {
            this.shadow = shadow;
            return this;
        }

        public ChoiceDanweiDialog.Builder setTitle(String title) {
            this.p.menuTitle = title;
            return this;
        }

        public ChoiceDanweiDialog.Builder addMenu(String text, View.OnClickListener listener) {
            ChoiceDanweiDialog.BottomMenu bm = new ChoiceDanweiDialog.BottomMenu(text, listener);
            this.p.menuList.add(bm);
            return this;
        }

        public ChoiceDanweiDialog.Builder addMenu(int textId, View.OnClickListener listener) {
            return addMenu(p.context.getString(textId), listener);
        }

        public ChoiceDanweiDialog.Builder setCancelListener(View.OnClickListener cancelListener) {
            p.cancelListener = cancelListener;
            return this;
        }

        public ChoiceDanweiDialog.Builder setCancelText(int resId) {
            p.cancelText = p.context.getString(resId);
            return this;
        }

        public ChoiceDanweiDialog.Builder setCancelText(String text) {
            p.cancelText = text;
            return this;
        }

        public ChoiceDanweiDialog create() {
            final ChoiceDanweiDialog dialog = new ChoiceDanweiDialog(p.context, shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            ...
            for (int i = 0; i < p.menuList.size(); i++) {
                ChoiceDanweiDialog.BottomMenu bottomMenu = p.menuList.get(i);
