...
public class TaskItemFragment3 extends BaseFragment {
    ...
    private void getdata(final boolean type,final int mtype){
        Observable observable =
                ApiUtils.getApi().GetMissionDetails(new GetMissionDetailsBody(BaseActivity.getuser().UserId,mtype+"","3"))
