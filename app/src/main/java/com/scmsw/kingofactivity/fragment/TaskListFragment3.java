...
public class TaskListFragment3 extends BaseFragment {
    ...
    protected void initData() {
        ...
        madpater = new TaskListAdpater(mContext,mListdata,"已作废");
        ...
        madpater.setOnItemListCilicLister(new ListOnclickLister() {
            ...
            public void onclick(View v, int position) {
                TaskDetailActivity.startactivity(mContext,mListdata.get(position),"已作废");
            }
        });
        getdata();
    }
...
//            mYRecycleview.setLayoutAnimation(controller);
    ...
    private void getdata(){
        ...
        Observable observable =
                ApiUtils.getApi().tasklistdata(new TasklistdataBody(BaseActivity.getuser().UserId,"已作废"))
