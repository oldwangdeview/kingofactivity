...
public class TaskItemFragment2 extends BaseFragment {
    ...
    private void getdata(final boolean type,int mtype){
        Observable observable =
                ApiUtils.getApi().GetMissionDetails(new GetMissionDetailsBody(BaseActivity.getuser().UserId,mtype+"","2"))
