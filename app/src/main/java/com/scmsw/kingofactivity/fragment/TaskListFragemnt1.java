...
public class TaskListFragemnt1 extends BaseFragment {
    ...
    protected void initData() {
        ...
        madpater = new TaskListAdpater(mContext,mListdata,"未完成");
        ...
        madpater.setOnItemListCilicLister(new ListOnclickLister() {
            ...
            public void onclick(View v, int position) {
                TaskDetailActivity.startactivity(mContext,mListdata.get(position),"未完成");
            }
        });
        getdata();
    }
...
//            mYRecycleview.setLayoutAnimation(controller);
    ...
    private void getdata(){
        ...
        Observable observable =
                ApiUtils.getApi().tasklistdata(new TasklistdataBody(BaseActivity.getuser().UserId,"未完成"))
