...
public class TaskListFragment  extends BaseFragment {
    ...
    protected void initData() {
        ...
        madpater = new TaskListAdpater(mContext,mListdata,"未过审");
        ...
        madpater.setOnItemListCilicLister(new ListOnclickLister() {
            ...
            public void onclick(View v, int position) {
                TaskDetailActivity.startactivity(mContext ,mListdata.get(position),"未过审");
            }
        });
        getdata();
    }
...
//            mYRecycleview.setLayoutAnimation(controller);
    ...
    private void getdata(){
        ...
        Observable observable =
                ApiUtils.getApi().tasklistdata(new TasklistdataBody(BaseActivity.getuser().UserId,"未过审"))
