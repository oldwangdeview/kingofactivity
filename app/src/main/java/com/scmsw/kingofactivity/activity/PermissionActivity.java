...
import com.scmsw.kingofactivity.util.CheckPermission;


/**
 * @autor oldwang
 * @time 2017/11/12 11:24
 * @des ${TODO}
 */
public class PermissionActivity extends Activity {
    //首先声明权限授权
    public static final int PERMISSION_GRANTED = 2003;//标识权限授权
    public static final int PERMISSION_DENIEG = 2005;//权限不足，权限被拒绝的时候
    private static final int PERMISSION_REQUEST_CODE = 0;//系统授权管理页面时的结果参数
    private static final String EXTRA_PERMISSION = "com.perssion";//权限参数
